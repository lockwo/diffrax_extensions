...
class VirtualBrownianTree(AbstractBrownianPath):
    ...
    !!! info "Lévy Area"
        ...
        - [`diffrax_extensions.BrownianIncrement`][] (default, generates the increment of W)
        - [`diffrax_extensions.SpaceTimeLevyArea`][] (generates W and the space-time Lévy area H)
        - [`diffrax_extensions.SpaceTimeTimeLevyArea`][] (generates W, H and the space-time-time
                                                Lévy area K)
